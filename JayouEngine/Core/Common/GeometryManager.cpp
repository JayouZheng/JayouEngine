...
GeometryData<ColorVertex> GeometryCreator::CreateDefaultBox()
{
	GeometryData<ColorVertex> meshData;
...
GeometryData<Vertex> GeometryCreator::CreateBox(float width, float height, float depth, uint32 numSubdivisions)
{
...
GeometryData<Vertex> GeometryCreator::CreateSphere(float radius, uint32 sliceCount, uint32 stackCount)
{
	GeometryData<Vertex> meshData;
...
GeometryData<Vertex> GeometryCreator::CreateGeosphere(float radius, uint32 numSubdivisions)
{
	GeometryData<Vertex> meshData;
...
GeometryData<Vertex> GeometryCreator::CreateCylinder(float bottomRadius, float topRadius, float height, uint32 sliceCount, uint32 stackCount)
{
	GeometryData<Vertex> meshData;
...
GeometryData<Vertex> GeometryCreator::CreateQuad(float x, float y, float w, float h, float depth)
{
	GeometryData<Vertex> meshData;
...
void GeometryCreator::Subdivide(GeometryData<Vertex>& meshData)
{
	// Save a copy of the input geometry.
	GeometryData<Vertex> inputCopy = meshData;
...
Vertex GeometryCreator::MidPoint(const Vertex& v0, const Vertex& v1)
{
...
void GeometryCreator::BuildCylinderTopCap(float bottomRadius, float topRadius, float height,
	uint32 sliceCount, uint32 stackCount, GeometryData<Vertex>& meshData)
{
...
void GeometryCreator::BuildCylinderBottomCap(float bottomRadius, float topRadius, float height,
	uint32 sliceCount, uint32 stackCount, GeometryData<Vertex>& meshData)
{
	// 
	// Build bottom cap.
