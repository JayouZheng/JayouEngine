...
namespace Math
{
    ...
    public:
        INLINE AffineTransform()
			: m_basis(kIdentity), m_translation(kZero) {} // Modified.
		...
		INLINE AffineTransform Scale(float scale) { return *this * MakeScale(scale); }
		INLINE AffineTransform Scale(Vector3 scale) { return *this * MakeScale(scale); }

		INLINE AffineTransform TranslationX(float x) { m_translation.SetX(x); return *this; }
		INLINE AffineTransform TranslationY(float y) { m_translation.SetY(y); return *this; }
		INLINE AffineTransform TranslationZ(float z) { m_translation.SetZ(z); return *this; }

		INLINE AffineTransform Translation(Vector3 translate) { m_translation = translate; return *this; }
		//////////////////////////////////////////////////////////////////////////////////////
